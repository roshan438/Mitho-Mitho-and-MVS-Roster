    ...
    <>
      ...
      {fbUser && role === "admin" && (
        <nav className="admin-toolbar">
          <div className="admin-scroll-container">
            <div className="admin-nav-group">
              <Link to="/admin/dashboard" className={`admin-link ${isActive("/admin/dashboard")}`}>
                Dashboard
              </Link>
              <Link to="/admin/approvals" className={`admin-link ${isActive("/admin/approvals")}`}>
                Approvals
              </Link>
              <Link to="/admin/roster" className={`admin-link ${isActive("/admin/roster")}`}>
                Roster
              </Link>
              <Link to="/admin/payroll" className={`admin-link ${isActive("/admin/payroll")}`}>
                Payroll
              </Link>
              <Link
                to="/admin/admin-payroll"
                className={`admin-link ${isActive("/admin/admin-payroll")}`}
              >
                Pay Staff
              </Link>
              <Link
                to="/admin/edit-timesheets"
                className={`admin-link ${isActive("/admin/edit-timesheets")}`}
              >
                Timesheets
              </Link>
              <Link to="/admin/audit" className={`admin-link ${isActive("/admin/audit")}`}>
                Audit
              </Link>
              <Link
                to="/admin/store-settings"
                className={`admin-link ${isActive("/admin/store-settings")}`}
              >
                Settings
              </Link>
            </div>

            <Link to="/admin/staff" className={`admin-link staff-right ${isActive("/admin/staff")}`}>
              Staff List
            </Link>
          </div>
        </nav>
            ...
            <div className="side-menu-links">
              ...
              {role === "admin" && (
                <>
                  ...
                  <Link to="/admin/roster" onClick={closeMenu}>
                    Roster
                  </Link>
                  <Link to="/admin/payroll" onClick={closeMenu}>
                    Payroll
                  </Link>
                  <Link to="/admin/admin-payroll" onClick={closeMenu}>
                    Pay Staff
                  </Link>
                  <Link to="/admin/edit-timesheets" onClick={closeMenu}>
                    Timesheets
                  </Link>
                  <Link to="/admin/staff" onClick={closeMenu}>
                    Staff List
                  </Link>
                  <Link to="/admin/store-settings" onClick={closeMenu}>
                    Store Settings
                  </Link>
                </>
              )}
