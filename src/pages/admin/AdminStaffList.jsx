...
function getAvailabilitySummary(availability) {
  if (!availability) return "Not submitted";
  ...
  return enabledDays
    .map((day) => {
      ...
      if (row?.start && row?.end) {
        return `${labelize(day)} ${row.start}-${row.end}`;
      }
      return labelize(day);
    })
    .join(" • ");
...
export default function AdminStaffList() {
  ...
  const selectedAvailabilitySummary = useMemo(() => {
    ...
    return getAvailabilitySummary(selectedProfile.availability);
  }, [selectedProfile]);
            ...
            >
              <div className="staff-info">
                ...
                <div className="staff-card-meta">
                  ...
                  >
                    {member.availabilitySubmitted ? "Availability Set" : "No Availability"}
                  </span>
                </div>
