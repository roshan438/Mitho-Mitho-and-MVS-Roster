...
export default function Login() {
  ...
  async function routeUser(uid) {
    ...
    if (!profile) {
      showToast("We could not load your account profile yet. Please try again.", "error");
      nav("/login");
      return;
    }

    if (profile?.role === "admin") {
      showToast("Welcome back, admin.", "success", { title: "Signed in" });
      nav("/admin/dashboard");
      return;
    }
    ...
    if (profile?.status === "approved") {
      showToast("Welcome back.", "success", { title: "Signed in" });
      nav("/staff/today");
      return;
    }
